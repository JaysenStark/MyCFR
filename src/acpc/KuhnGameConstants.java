...
public interface KuhnGameConstants {
	...
	public static final int NUM_HOLECARDS = 1;
	public static final int [] NUM_BOARDCARDS = {0};
	public static final String BETTING_TYPE = "limit";
